...
if uploaded_file:
    ...
    st.markdown(
    "This chart shows which features the Random Forest model considered most important in predicting income. "
    "Higher values indicate a stronger influence on the model's decision — for instance, 'education-num' or 'hours-per-week' often rank high."
)
    ...
    income_counts = df['income'].value_counts(normalize=True) * 100  # in %
